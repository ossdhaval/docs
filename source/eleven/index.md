...
This is a PKCS11 REST API that can be used for key operations by the auth-server in lieu of local storage of private keys. 

## API Reference

### /generateKey

- **URL:** https://ce.jans.info:8443/jans-eleven/rest/jans-eleven/generateKey
- **Method:** POST
...
```
POST /jans-eleven/rest/jans-eleven/generateKey HTTP/1.1
Host: ce.jans.info:8443
...
- **URL:** https://ce.jans.info:8443/jans-eleven/rest/jans-eleven/sign
- **Method:** POST
...
```
POST /jans-eleven/rest/jans-eleven/sign HTTP/1.1
Host: ce.jans.info:8443
...
- **URL:** https://ce.jans.info:8443/jans-eleven/rest/jans-eleven/verifySignature
- **Method:** POST
- **Media Type:** application/json
- **Data Params**
    - accessToken [string]
...
```
POST /jans-eleven/rest/jans-eleven/verifySignature HTTP/1.1
Host: ce.jans.info:8443
Content-Type: application/json
Cache-Control: no-cache
Authorization: Bearer xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx
...
```
POST /eleven/rest/eleven/verifySignature HTTP/1.1
Host: ce.jans.info:8443
Content-Type: application/json
Cache-Control: no-cache
Authorization: Bearer xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx
...
- **URL:** https://ce.jans.info:8443/jans-eleven/rest/jans-eleven/deleteKey
- **Method:** POST
- **Media Type:** application/x-www-form-urlencoded
- **Data Params**
    - accessToken [string]
...
```
POST /jans-eleven/rest/jans-eleven/deleteKey HTTP/1.1
Host: ce.jans.info:8443
Cache-Control: no-cache
Content-Type: application/x-www-form-urlencoded
Authorization: Bearer xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx
...
Eleven is deployed automatically when Janssen is installed.

## Security Considerations

This service should not be Internet facing.
